...
def main():
    ...
    # HR images
    opt['input_folder'] = r'E:\SRClass\archive\cell_images\cell_images\Parasitized'
    opt['save_folder'] = r'E:\SRClass\archive\cell_images\cell_images\Parasitized_HR_sub'
    opt['crop_size'] = 96 #480
    opt['step'] = 240
    opt['thresh_size'] = 0
